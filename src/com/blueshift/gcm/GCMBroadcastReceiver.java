...
import static com.blueshift.gcm.GCMConstants.DEFAULT_INTENT_SERVICE_CLASS_NAME;

/**
 * {@link android.content.BroadcastReceiver} that receives GCM messages and delivers them to
 * an application-specific {@link com.blueshift.gcm.GCMBaseIntentService} subclass.
 * <p>
 * By default, the {@link com.blueshift.gcm.GCMBaseIntentService} class belongs to the application
...
public class GCMBroadcastReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        com.blueshift.gcm.GCMBaseIntentService.runIntentInService(context, intent, className);
    ...
    static final String getDefaultIntentServiceClassName(Context context) {
        String className = "com.blueshift.gcm" +
